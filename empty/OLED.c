...
extern int32_t Get_Encoder_countA,encoderA_cnt,PWMA,Get_Encoder_countB,encoderB_cnt;
//OLED的显存
//存放格式如下.
//[0]0 1 2 3 ... 127	
//[1]0 1 2 3 ... 127	
...
{
    // 显示编码器A的值
    OLED_ShowString(0, 0, "EncA:", 16);  // 在(0,0)位置显示标签，16号字体
    OLED_ShowNum(40, 0, Get_Encoder_countA, 8, 16); // 在(40,0)显示数值，最多8位，16号字体
    
    // 显示编码器B的值
    OLED_ShowString(0, 2, "EncB:", 16);  // 在(0,2)位置显示标签，16号字体
    OLED_ShowNum(40, 2, Get_Encoder_countB, 8, 16); // 在(40,2)显示数值，最多8位，16号字体
}